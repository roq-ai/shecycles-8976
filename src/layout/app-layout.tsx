...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const { data, error, isLoading } = useSWR<PlatformInterface[]>(
    ...
    () => getPlatforms({ tenant_id: session?.user?.tenantId }),
  );
  loading = isLoading;
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    {
      name: 'Carbon Offset Investor',
      path: '/carbon-offset-investors',
    ...
    {
      name: 'Gov Subsidy Provider',
      path: '/gov-subsidy-providers',

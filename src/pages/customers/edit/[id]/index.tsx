      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        {isLoading || (!formik.values && !error) ? (
          ...
          <form onSubmit={formik.handleSubmit}>
            <FormControl id="rental_details" mb="4" isInvalid={!!formik.errors?.rental_details}>
              <FormLabel>Rental Details</FormLabel>
              <Input
                type="text"
                name="rental_details"
                value={formik.values?.rental_details}
                onChange={formik.handleChange}
              />
              {formik.errors.rental_details && <FormErrorMessage>{formik.errors?.rental_details}</FormErrorMessage>}
            </FormControl>
